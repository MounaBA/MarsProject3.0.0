...
const Color kRose = Color(0xFFFF1744);
const Color KBlue = Color(0xFF17202A);
...
// Assets
const String kGoogleLogoPath = 'package:mars/assets/images/google_logo.png';
const String back = 'lib/photo/ball.jpg';
